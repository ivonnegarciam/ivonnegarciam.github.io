...
```García-Martínez, I. M.``` Sheinbaum, J., Zavala Sansón, L., Jouanno, J., and Pallàs Sanz, E. Upper-ocean response to strong wind forcing in a Loop Current Eddy. Submitted to Journal of Physical Oceanography. 
...
<br>Modelling: WRF (atmospheric model), NEMO (ocean model), OASIS (coupler)
